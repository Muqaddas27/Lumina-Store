  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-extrabold text-gray-900 mb-4 tracking-tight">Frequently Asked Questions</h1>
        <p className="text-lg text-gray-600">Quick answers to common questions about Lumina.</p>
      </div>
          ...
          <div key={catIdx}>
            ...
            <div className="space-y-4">
              {cat.questions.map((q, qIdx) => {
                ...
                return (
                  <div key={id} className="border border-gray-200 rounded-2xl bg-white overflow-hidden transition-all duration-300">
                    <button 
                      onClick={() => toggle(id)}
      ...
      <div className="mt-20 bg-gray-900 rounded-3xl p-10 text-center text-white">
        ...
        <p className="text-gray-400 mb-8">We're here to help. Reach out to our customer support team.</p>
        <a 
          href="#/contact" 
          className="inline-block px-8 py-3 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition-all"
        >
          Contact Support
        </a>
      </div>
