...
const AboutView: React.FC = () => {
  ...
  return (
    <div className="pb-20 bg-white dark:bg-gray-950 transition-colors duration-300">
      {/* Hero */}
      <section className="relative h-[400px] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 px-4">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 dark:text-white">Our Story</h1>
          <p className="text-xl text-gray-200 max-w-2xl mx-auto font-medium dark:text-gray-300">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Founded on a simple idea.</h2>
