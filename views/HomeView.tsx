...
const HomeView: React.FC = () => {
  ...
  return (
    <div className="space-y-16 pb-20">
      ...
      {/* Featured Products */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-800 py-16 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
        <div className="flex justify-between items-end mb-10">
          <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <div key={i} className="flex items-center p-8 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700">
      ...
      {/* Best Sellers */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 py-16 rounded-3xl shadow-sm border border-purple-100 dark:border-purple-800">
        <div className="text-center mb-12">
      ...
      {/* Newsletter Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-indigo-900 dark:bg-indigo-950 rounded-3xl overflow-hidden relative p-8 md:p-16 text-center text-white">
